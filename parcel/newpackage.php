	...
	<section class="wrapper">
		...
		<div class="row">
	        <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12 col-md-push-2 ">
	                    	<h2 style="text-align: center; font-weight: bold;text-shadow: 2px 2px orange">ADD CONSIGNMENT</h2>
		                                        ...
		                                        <div class="form-group" id="name-field">
		                                        	...
		                                        	<div class="input-group">
									        			<span class="input-group-addon" style="font-weight:bold">NAME*</span>
									        			 ...
									        			 <input type="text" onkeypress="letlevel1()"  id="sendername" class="form-control" id="form-name" name="form-name" style="color: black" placeholder="Name.." required>
									    			</div>		                                           
		                                        </div>
		                                    </div>
		                                        ...
		                                        <div class="form-group" id="email-field">
		                                        	...
		                                        	<div class="input-group">
									        			<span class="input-group-addon" style="font-weight:bold">E-MAIL*</span>
									        			 ...
									        			 <input type="email" onkeypress="letlevel2()" id="senderemail" class="form-control" id="form-email" name="form-email" placeholder="Email.." required>
									    			</div>		                                            
		                                        </div>
		                                    </div>
	                                	</div>
		                                        ...
		                                        <div class="form-group" id="name-field">
		                                        	<div class="input-group">
									        			<span class="input-group-addon" style="font-weight:bold">PHONE*</span>
									        			 ...
									        			 <input type="number" onkeypress="letlevel3()" id="senderphone" class="form-control" id="form-name" name="form-name" placeholder="PHONE.." required>
									    			</div>
		                                        </div>
		                                    </div>
		                                        ...
		                                        <div class="form-group" id="email-field">
		                                        	...
		                                        	<div class="input-group">
									        			<span class="input-group-addon" style="font-weight:bold">ADDRESS*</span>
									        			 ...
									        			 <input type="" onkeypress="letlevel4()" id="senderaddress" class="form-control" id="form-email" name="form-email" placeholder="ADDRESS.." required>
									    			</div>		                                           
		                                        </div>
		                                    </div>
	                                	</div>
		                                        ...
		                                        <div class="form-group" id="name-field">
		                                        	<div class="input-group">
									        			<span class="input-group-addon" style="font-weight:bold">NAME*</span>
									        			  ...
									        			  <input type="text" onkeypress="letlevel5()" id="recname" class="form-control" id="form-name" name="form-name" placeholder="Name.." required>
									    			</div>				    			
		                                        </div>
		                                    </div>
		                                        ...
		                                        <div class="form-group" id="email-field">
		                                        	<div class="input-group">
									        			<span class="input-group-addon" style="font-weight:bold">E-MAIL*</span>
									        			  ...
									        			  <input type="email" onkeypress="letlevel6()" id="recemail" class="form-control" id="form-email" name="form-email" placeholder="Email.." required>
									    			</div>		                                           
		                                        </div>
		                                    </div>
	                                	</div>
		                                        ...
		                                        <div class="form-group" id="name-field">
		                                        	...
		                                        	<div class="input-group">
									        			<span class="input-group-addon" style="font-weight:bold">PHONE*</span>
									        			  ...
									        			  <input type="number" onkeypress="letlevel7()" id="recphone" class="form-control" id="form-name" name="form-name" placeholder="PHONE.." required>
									    			</div>		                                            
		                                        </div>
		                                    </div>
		                                        ...
		                                        <div class="form-group" id="email-field">
		                                        	...
		                                        	<div class="input-group">
									        			<span class="input-group-addon" style="font-weight:bold">ADDRESS*</span>
									        			 ...
									        			 <input type="email" onkeypress="letlevel8()" id="recaddress" class="form-control" id="form-email" name="form-email" placeholder="ADDRESS.." required>
									    			</div>	
	                        			 	...
	                        			 	<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
		                                        <div class="form-group" id="name-field">
		                                            <div class="input-group">
									        			...
									        			<input required="yes" onkeypress="letlevel9()" id="origin"   type="" class="form-control text-nonez"  placeholder="" maxilen="11"  >
									    			</div>
		                                        </div>
		                                    </div>
		                                    ...
		                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
		                                        <div class="form-group" id="name-field">
		                                            <div class="input-group">
									        			...
									        			<input required="yes" onkeypress="letlevel10()" id="package"   type="" class="form-control text-nonez"  placeholder="" maxilen="11"  >
									    			</div>
		                                        </div>
		                                    </div>                          
	                                	</div>
	                        			 	...
	                        			 	<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
		                                        <div class="form-group" id="name-field">
		                                            <div class="input-group">
									        			...
									        			<input required="yes" onkeypress="letlevel11()" id="destination"   type="" class="form-control text-nonez"  placeholder="" maxilen="11"  >
									    			</div>
		                                        </div>
		                                    </div>
		                                    ...
		                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
		                                        <div class="form-group" id="name-field">
		                                            <div class="input-group">
									        			...
									        			<input required="yes" onkeypress="letlevel12()"  id="carrier"  type="" class="form-control text-nonez"  placeholder="" maxilen="11"  >
									    			</div>
		                                        </div>
		                                    </div>                          
	                                	</div>
	                        			 	...
	                        			 	<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
		                                        <div class="form-group" id="name-field">
		                                            <div class="input-group">
									        			...
									        			<input required="yes" onkeypress="letlevel13()" id="weight"  type="" class="form-control text-nonez"  placeholder="" maxilen="11"  >
									    			</div>
		                                        </div>
		                                    </div>
		                                    ...
		                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
		                                        <div class="form-group" id="name-field">
		                                            <div class="input-group">
									        			...
									        			<input required="yes" onkeypress="letlevel14()" id="shipmode"   type="" class="form-control text-nonez"  placeholder="" maxilen="11"  >
									    			</div>
		                                        </div>
		                                    </div>                          
	                                	</div>
	                        			 	...
	                        			 	<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
		                                        <div class="form-group" id="name-field">
		                                            <div class="input-group">
									        			...
									        			<input required="yes" onkeypress="letlevel15()" id="product"   type="" class="form-control text-nonez"  placeholder="" maxilen="11"  >
									    			</div>
		                                        </div>
		                                    </div>
		                                    ...
		                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
		                                        <div class="form-group" id="name-field">
		                                            <div class="input-group">
									        			...
									        			<input required="yes" onkeypress="letlevel16()" id="qty"  type="" class="form-control text-nonez"  placeholder="" maxilen="11"  >
									    			</div>
		                                        </div>
		                                    </div>                          
	                                	</div>
	                        			 	...
	                        			 	<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
		                                        <div class="form-group" id="name-field">
		                                            <div class="input-group">
									        			...
									        			<input required="yes" onkeypress="letlevel17()" id="totalfreight"  type="" class="form-control text-nonez"  placeholder="" maxilen="11"  >
									    			</div>
		                                        </div>
		                                    </div>
		                                    ...
		                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
		                                        <div class="form-group" id="name-field">
		                                            <div class="input-group">
									        			...
									        			<input required="yes" onkeypress="letlevel18()" id="expdeldate"   type="" class="form-control text-nonez"  placeholder="EXPECTED DELIVERY DATE" maxilen="11"  >
									    			</div>
		                                        </div>
		                                    </div>                          
	                                	</div>
	                        			 	...
	                        			 	<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
		                                        <div class="form-group" id="name-field">
		                                            <div class="input-group">
									        			...
									        			<input required="yes" onkeypress="letlevel19()" id="pickupdate"   type="" class="form-control text-nonez"  placeholder="" maxilen="11"  >
									    			</div>
		                                        </div>
		                                    </div>
		                                    ...
		                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
		                                        <div class="form-group" id="name-field">
		                                            <div class="input-group">
									        			...
									        			<input required="yes" onkeypress="letlevel20()" id="pickuptime"   type="" class="form-control text-nonez"  placeholder="" maxilen="11"  >
									    			</div>
		                                        </div>
		                                    </div>                          
	                                	</div>
	                        			 	...
	                        			 	<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
		                                        <div class="form-group" id="name-field">
		                                            <div class="input-group">
									        			...
									        			<input required="yes" onkeypress="letlevel21()" id="comment"   type="" class="form-control text-nonez"  placeholder="" maxilen="11"  >
									    			</div>
		                                        </div>
		                                    </div>
