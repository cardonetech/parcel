		...
		<div class="row"  >
			<div class="col-md-8" style="background:black">
			 ...
			 <div class="card panel-success">
                            <div class="card-header bg-danger" style="margin-bottom:10px">
                                <h6 style=" font-weight: bold;text-align: center;">Shipment History for <?php echo $tracknum ?></h6>
                            </div>
                            <div class="card-body table-responsive" style="overflow-x: scroll;">
                                ...
                                if($hisrtn){ ?>
                                    ...
                                    while ($row=mysqli_fetch_assoc($hisrst)) {
                                        ...
                                        $id=$row['id'];
                                        $tracknum = $row["histracknum"];
                                        $id=base64_encode($tracknum);
                                     ?>
                                     ...
                                     <tr>
                                         ...
                                         <td style="font-size:11px"><?php echo $histime  ?></td> 
                                          <td style="font-size:11px"><?php echo $hislocation  ?></td> 
                                           ...
                                           <td style="font-size:11px"><?php echo "Parcel Care Express"  ?></td> 
                                           <td style="font-size:11px"><?php echo $hisremark  ?></td>  
                                           <td style="font-size:11px"><a href="historyview?cst=<?php echo $id ?>" class="btn btn-small btn-info">Edit</a></td>  
                                     </tr>
