        ...
        <div class="container py-lg-5 py-md-4 py-2">
            <div class="row align-items-center">
                <div class="col-lg-6 pe-lg-5">
                    ...
                    <h3 class="title-w3l mb-2">We have Over 20 years of work experience.
                    </h3>

                    <p class="mt-3">Parcel Care Courier Services is one of the world's leading logistics companies, offering unrivaled courier, cargo, and specialized transport services across Europe, America, Africa, Asia, and beyond, as well as other specialized services to meet specific client needs, as we recognize the unique nature of business in our operating environment. We are committed to creating the most innovative logistics solution that offers individual and collaborative clients a delicate balance of time and cost-saving benefits delivered through our uniquely designed intra-city distribution network, as well as the assurance of the Parcel Care Courier Services tradition of quality services.  </p>
                    <div class="row two-grids mt-5 pt-lg-4">
                        <div class="col-sm-6 grids_info d-flex">
                            <i class="fas fa-chalkboard-teacher"></i>
                            <div class="detail ms-3">
                                <h4>Tracking Is Easy</h4>
                                <p>Know the wellfare of your package with our easy to track abilities
                                </p>
                            </div>
                        </div>
                        <div class="col-sm-6 grids_info d-flex mt-sm-0 mt-4">
                            ...
                            <div class="detail ms-3">
                                ...
                                <p>We have multiple warehouses accros several countries in the globe.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="w3l-project-in">
                <div class="row bottom-info text-left">
                    <div class="col-lg-7 w3l-project-in-left pe-lg-5">
                        <h6 class="title-subw3hny mb-2">Get free Estimate</h6>
                        <h3 class="title-w3l two mb-2">We Are Here To Manage Quality Consulting Service
                        </h3>
                    ...
                    <div class="col-lg-5 w3l-project-in-right">
                        <div class="w3banner-content-btns">
                            <!-- <a href="about" class="btn btn-style btn-white mt-4">Read More </a> -->
        ...
        <div class="container content-gd py-lg-5">
            <div class="row mt-3">
                <div class="col-lg-6 faqw3-right pe-lg-5">
                    ...
                    <img src="assets/images/faq.png" style="height: 300px; width: 80%;">
                ...
                <div class="col-lg-6 faqw3-left">
                   <!--  <div class="accordion" id="accordionExample">
                    ...
                    <div class="col-md-12">
                        <h4 style="color:#1e90ff; margin-bottom: 20px;text-align:center;">Parcel Care COURIER SERVICES GLOBAL FORWARDING, FREIGHT</h4>

                        <p>In its daily business Parcel Care Courier Services Forwarding takes care of a variety of customers’ logistics needs, from standardized logistics operations and multi-modal transport solutions to highly individualized industrial projects.</p>

                        <hr>
                    </div>

                     <div class="col-md-12">
                        <h4 style="color:#1e90ff; margin-bottom: 20px;text-align:center;">Supply Chain</h4>

                        <p>Parcel Care Courier Services Supply Chain is the global market leader in contract logistics, providing warehousing, managed transport and value-added services and offers solutions for corporate information and communications management.</p>
